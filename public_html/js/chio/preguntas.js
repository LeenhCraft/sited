  ...
  validarFormulario() {
    ...
    switch (tipoRespuesta.nombre) {
      case "Opción múltiple":
        ...
        if (!opcionCorrecta) {
          this.showToast("Debe indicar cuál es la opción correcta", "warning");
          return false;
        }
      ...
      case "Respuesta corta":
        ...
        if (
          ...
          this.showToast("Debe ingresar una longitud máxima válida", "warning");
          return false;
        }
        break;
      ...
      case "Escala Likert":
        ...
        if (!valoresLikert) {
          this.showToast("Debe ingresar valores para las opciones", "warning");
          return false;
        }
    ...
    switch (tipoNombre) {
      ...
      case "Selección múltiple":
        ...
        if (metadatos.correctas && metadatos.correctas.length > 0) {
          ...
          this.formPregunta.querySelector('[name="opciones_correctas"]').value =
            correctasBase1.join(", ");
        }
        break;
      ...
      case "Respuesta corta":
        ...
        if (metadatos.ejemplo) {
          this.formPregunta.querySelector('[name="respuesta_ejemplo"]').value =
            metadatos.ejemplo;
      ...
      case "Escala":
        ...
        if (metadatos.descripcion) {
          this.formPregunta.querySelector('[name="descripcion_escala"]').value =
