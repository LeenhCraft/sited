                                        ...
                                        <div class="col-md-8 offset-md-2">
                                            ...
                                            <form id="form-datos-antropometricos" class="mt-4">
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-floating">
                                                            <input type="number" class="form-control rounded-lg" id="altura" name="altura" step="0.1" min="0" max="300" value="<?php echo isset($data['user']['altura']) && $data['user']['altura'] > 3 ? $data['user']['altura'] : (isset($data['user']['altura']) ? $data['user']['altura'] * 100 : ''); ?>" required>
